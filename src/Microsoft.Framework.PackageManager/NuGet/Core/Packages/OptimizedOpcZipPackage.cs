...
namespace NuGet
{
    ...
    /// </remarks>
    public class OptimizedOpcZipPackage : LocalPackage
    {
        ...
        public OptimizedOpcZipPackage(string fullPackagePath)
        {
        ...
        public OptimizedOpcZipPackage(IFileSystem fileSystem, string packagePath)
        {
            if (fileSystem == null)
            {
        ...
        public OptimizedOpcZipPackage(IFileSystem fileSystem, string packagePath, IFileSystem expandedFileSystem)
        {
            if (fileSystem == null)
            {
                throw new ArgumentNullException("fileSystem");
        ...
        /// <exception cref="System.ArgumentNullException">fileSystem</exception>
        /// <exception cref="System.ArgumentException">packagePath</exception>
        internal OptimizedOpcZipPackage(IFileSystem fileSystem, string packagePath, IFileSystem expandedFileSystem, bool forceUseCache) :
